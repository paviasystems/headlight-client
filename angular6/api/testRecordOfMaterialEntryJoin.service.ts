...
export class TestRecordOfMaterialEntryJoinService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public readsFiltered(begin: number, max: number, filter: string, observe?: 'body', reportProgress?: boolean): Observable<Array<TestRecordOfMaterialEntryJoin>>;
    public readsFiltered(begin: number, max: number, filter: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TestRecordOfMaterialEntryJoin>>>;
    public readsFiltered(begin: number, max: number, filter: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TestRecordOfMaterialEntryJoin>>>;
