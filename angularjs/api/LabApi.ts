...
export class LabApi {
     ...
     * @param body 
     */
    public create (body: models.Lab, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Lab> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Lab>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Lab>> {
        const localVarPath = this.basePath + '/Lab/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Lab> {
        const localVarPath = this.basePath + '/Lab/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Lab>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Lab>> {
        const localVarPath = this.basePath + '/Labs/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Lab>> {
     ...
     * @param body 
     */
    public update (body: models.Lab, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Lab> {
        const localVarPath = this.basePath + '/Lab';
