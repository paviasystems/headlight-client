...
export class MaterialPayItemJoinApi {
     ...
     * @param body 
     */
    public create (body: models.MaterialPayItemJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialPayItemJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialPayItemJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialPayItemJoin>> {
        const localVarPath = this.basePath + '/MaterialPayItemJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialPayItemJoin> {
        const localVarPath = this.basePath + '/MaterialPayItemJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialPayItemJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialPayItemJoin>> {
        const localVarPath = this.basePath + '/MaterialPayItemJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialPayItemJoin>> {
     ...
     * @param body 
     */
    public update (body: models.MaterialPayItemJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialPayItemJoin> {
        const localVarPath = this.basePath + '/MaterialPayItemJoin';
