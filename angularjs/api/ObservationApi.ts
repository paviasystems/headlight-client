...
export class ObservationApi {
     ...
     */
    public downloadObservationCollectionImage (IDProject: number, SpritePageNumber: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     */
    public downloadObservationImage (IDObservation: number, Size: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ObservationModel>> {
        const localVarPath = this.basePath + '/Observation/query/readsLite';
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ObservationModel>> {
        const localVarPath = this.basePath + '/Observations/By/{field}/{value}/{begin}/{max}'
