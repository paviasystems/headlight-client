...
export class ReportApi {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ReportModel>> {
        const localVarPath = this.basePath + '/Report/query/readsLite';
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ReportModel>> {
        const localVarPath = this.basePath + '/Reports/By/{field}/{value}/{begin}/{max}'
