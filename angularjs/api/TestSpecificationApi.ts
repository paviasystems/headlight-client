...
export class TestSpecificationApi {
     ...
     * @param body 
     */
    public create (body: models.TestSpecification, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecification> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecification>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecification>> {
        const localVarPath = this.basePath + '/TestSpecification/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecification> {
        const localVarPath = this.basePath + '/TestSpecification/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecification>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecification>> {
        const localVarPath = this.basePath + '/TestSpecifications/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecification>> {
     ...
     * @param body 
     */
    public update (body: models.TestSpecification, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecification> {
        const localVarPath = this.basePath + '/TestSpecification';
