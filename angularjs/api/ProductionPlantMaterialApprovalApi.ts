...
export class ProductionPlantMaterialApprovalApi {
     ...
     * @param body 
     */
    public create (body: models.ProductionPlantMaterialApproval, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProductionPlantMaterialApproval> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlantMaterialApproval>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlantMaterialApproval>> {
        const localVarPath = this.basePath + '/ProductionPlantMaterialApproval/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProductionPlantMaterialApproval> {
        const localVarPath = this.basePath + '/ProductionPlantMaterialApproval/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlantMaterialApproval>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlantMaterialApproval>> {
        const localVarPath = this.basePath + '/ProductionPlantMaterialApprovals/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlantMaterialApproval>> {
     ...
     * @param body 
     */
    public update (body: models.ProductionPlantMaterialApproval, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProductionPlantMaterialApproval> {
        const localVarPath = this.basePath + '/ProductionPlantMaterialApproval';
