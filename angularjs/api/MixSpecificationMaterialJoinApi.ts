...
export class MixSpecificationMaterialJoinApi {
     ...
     * @param body 
     */
    public create (body: models.MixSpecificationMaterialJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MixSpecificationMaterialJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecificationMaterialJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecificationMaterialJoin>> {
        const localVarPath = this.basePath + '/MixSpecificationMaterialJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MixSpecificationMaterialJoin> {
        const localVarPath = this.basePath + '/MixSpecificationMaterialJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecificationMaterialJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecificationMaterialJoin>> {
        const localVarPath = this.basePath + '/MixSpecificationMaterialJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecificationMaterialJoin>> {
     ...
     * @param body 
     */
    public update (body: models.MixSpecificationMaterialJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MixSpecificationMaterialJoin> {
        const localVarPath = this.basePath + '/MixSpecificationMaterialJoin';
