...
export class ReportNamedInstanceApi {
     ...
     */
    public addReportNamedInstanceToProject (IDProject: number, IDReportNamedInstance: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ReportNamedInstanceModel>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ReportNamedInstanceModel>> {
        const localVarPath = this.basePath + '/ReportNamedInstance/query/readsLite';
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ReportNamedInstanceModel>> {
        const localVarPath = this.basePath + '/ReportNamedInstances/By/{field}/{value}/{begin}/{max}'
     ...
     * @param IDReportNamedInstance ID of record
     */
    public removeReportNamedInstanceFromProject (IDProject: number, IDReportNamedInstance: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
