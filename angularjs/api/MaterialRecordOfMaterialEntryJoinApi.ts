...
export class MaterialRecordOfMaterialEntryJoinApi {
     ...
     * @param body 
     */
    public create (body: models.MaterialRecordOfMaterialEntryJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialRecordOfMaterialEntryJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialRecordOfMaterialEntryJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialRecordOfMaterialEntryJoin>> {
        const localVarPath = this.basePath + '/MaterialRecordOfMaterialEntryJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialRecordOfMaterialEntryJoin> {
        const localVarPath = this.basePath + '/MaterialRecordOfMaterialEntryJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialRecordOfMaterialEntryJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialRecordOfMaterialEntryJoin>> {
        const localVarPath = this.basePath + '/MaterialRecordOfMaterialEntryJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialRecordOfMaterialEntryJoin>> {
     ...
     * @param body 
     */
    public update (body: models.MaterialRecordOfMaterialEntryJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialRecordOfMaterialEntryJoin> {
        const localVarPath = this.basePath + '/MaterialRecordOfMaterialEntryJoin';
