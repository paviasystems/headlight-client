...
export class PayItemApi {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.PayItemModel>> {
        const localVarPath = this.basePath + '/PayItem/query/readsLite';
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.PayItemModel>> {
        const localVarPath = this.basePath + '/PayItems/By/{field}/{value}/{begin}/{max}'
