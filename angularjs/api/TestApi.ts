...
export class TestApi {
     ...
     * @param body 
     */
    public create (body: models.Test, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Test> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Test>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Test>> {
        const localVarPath = this.basePath + '/Test/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Test> {
        const localVarPath = this.basePath + '/Test/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Test>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Test>> {
        const localVarPath = this.basePath + '/Tests/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Test>> {
     ...
     * @param body 
     */
    public update (body: models.Test, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Test> {
        const localVarPath = this.basePath + '/Test';
