...
export class TestSpecificationMaterialTestJoinApi {
     ...
     * @param body 
     */
    public create (body: models.TestSpecificationMaterialTestJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationMaterialTestJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationMaterialTestJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationMaterialTestJoin>> {
        const localVarPath = this.basePath + '/TestSpecificationMaterialTestJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationMaterialTestJoin> {
        const localVarPath = this.basePath + '/TestSpecificationMaterialTestJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationMaterialTestJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationMaterialTestJoin>> {
        const localVarPath = this.basePath + '/TestSpecificationMaterialTestJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationMaterialTestJoin>> {
     ...
     * @param body 
     */
    public update (body: models.TestSpecificationMaterialTestJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationMaterialTestJoin> {
        const localVarPath = this.basePath + '/TestSpecificationMaterialTestJoin';
