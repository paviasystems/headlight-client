...
export class SampleLineItemJoinApi {
     ...
     * @param body 
     */
    public create (body: models.SampleLineItemJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLineItemJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLineItemJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLineItemJoin>> {
        const localVarPath = this.basePath + '/SampleLineItemJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLineItemJoin> {
        const localVarPath = this.basePath + '/SampleLineItemJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLineItemJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLineItemJoin>> {
        const localVarPath = this.basePath + '/SampleLineItemJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLineItemJoin>> {
     ...
     * @param body 
     */
    public update (body: models.SampleLineItemJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLineItemJoin> {
        const localVarPath = this.basePath + '/SampleLineItemJoin';
