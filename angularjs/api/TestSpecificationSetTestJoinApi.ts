...
export class TestSpecificationSetTestJoinApi {
     ...
     * @param body 
     */
    public create (body: models.TestSpecificationSetTestJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationSetTestJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSetTestJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSetTestJoin>> {
        const localVarPath = this.basePath + '/TestSpecificationSetTestJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationSetTestJoin> {
        const localVarPath = this.basePath + '/TestSpecificationSetTestJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSetTestJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSetTestJoin>> {
        const localVarPath = this.basePath + '/TestSpecificationSetTestJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSetTestJoin>> {
     ...
     * @param body 
     */
    public update (body: models.TestSpecificationSetTestJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationSetTestJoin> {
        const localVarPath = this.basePath + '/TestSpecificationSetTestJoin';
