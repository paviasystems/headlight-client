...
export class TestInstanceDataArchiveApi {
     ...
     * @param body 
     */
    public create (body: models.TestInstanceDataArchive, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceDataArchive> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceDataArchive>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceDataArchive>> {
        const localVarPath = this.basePath + '/TestInstanceDataArchive/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceDataArchive> {
        const localVarPath = this.basePath + '/TestInstanceDataArchive/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceDataArchive>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceDataArchive>> {
        const localVarPath = this.basePath + '/TestInstanceDataArchives/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceDataArchive>> {
     ...
     * @param body 
     */
    public update (body: models.TestInstanceDataArchive, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceDataArchive> {
        const localVarPath = this.basePath + '/TestInstanceDataArchive';
