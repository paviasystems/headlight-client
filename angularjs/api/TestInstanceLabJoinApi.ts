...
export class TestInstanceLabJoinApi {
     ...
     * @param body 
     */
    public create (body: models.TestInstanceLabJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceLabJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceLabJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceLabJoin>> {
        const localVarPath = this.basePath + '/TestInstanceLabJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceLabJoin> {
        const localVarPath = this.basePath + '/TestInstanceLabJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceLabJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceLabJoin>> {
        const localVarPath = this.basePath + '/TestInstanceLabJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceLabJoin>> {
     ...
     * @param body 
     */
    public update (body: models.TestInstanceLabJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceLabJoin> {
        const localVarPath = this.basePath + '/TestInstanceLabJoin';
