...
export class LineItemApi {
     ...
     * @param body 
     */
    public create (body: models.LineItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LineItem> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LineItem>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LineItem>> {
        const localVarPath = this.basePath + '/LineItem/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LineItem> {
        const localVarPath = this.basePath + '/LineItem/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LineItem>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LineItem>> {
        const localVarPath = this.basePath + '/LineItems/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LineItem>> {
     ...
     * @param body 
     */
    public update (body: models.LineItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LineItem> {
        const localVarPath = this.basePath + '/LineItem';
