...
export class TestStepApi {
     ...
     * @param body 
     */
    public create (body: models.TestStep, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestStep> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestStep>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestStep>> {
        const localVarPath = this.basePath + '/TestStep/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestStep> {
        const localVarPath = this.basePath + '/TestStep/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestStep>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestStep>> {
        const localVarPath = this.basePath + '/TestSteps/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestStep>> {
     ...
     * @param body 
     */
    public update (body: models.TestStep, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestStep> {
        const localVarPath = this.basePath + '/TestStep';
