...
export class TestLabJoinApi {
     ...
     * @param body 
     */
    public create (body: models.TestLabJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestLabJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestLabJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestLabJoin>> {
        const localVarPath = this.basePath + '/TestLabJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestLabJoin> {
        const localVarPath = this.basePath + '/TestLabJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestLabJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestLabJoin>> {
        const localVarPath = this.basePath + '/TestLabJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestLabJoin>> {
     ...
     * @param body 
     */
    public update (body: models.TestLabJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestLabJoin> {
        const localVarPath = this.basePath + '/TestLabJoin';
