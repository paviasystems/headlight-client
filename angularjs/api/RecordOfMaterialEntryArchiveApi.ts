...
export class RecordOfMaterialEntryArchiveApi {
     ...
     * @param body 
     */
    public create (body: models.RecordOfMaterialEntryArchive, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterialEntryArchive> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntryArchive>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntryArchive>> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntryArchive/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterialEntryArchive> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntryArchive/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntryArchive>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntryArchive>> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntryArchives/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntryArchive>> {
     ...
     * @param body 
     */
    public update (body: models.RecordOfMaterialEntryArchive, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterialEntryArchive> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntryArchive';
