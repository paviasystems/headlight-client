...
export class TestSpecificationRequirementApi {
     ...
     * @param body 
     */
    public create (body: models.TestSpecificationRequirement, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationRequirement> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationRequirement>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationRequirement>> {
        const localVarPath = this.basePath + '/TestSpecificationRequirement/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationRequirement> {
        const localVarPath = this.basePath + '/TestSpecificationRequirement/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationRequirement>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationRequirement>> {
        const localVarPath = this.basePath + '/TestSpecificationRequirements/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationRequirement>> {
     ...
     * @param body 
     */
    public update (body: models.TestSpecificationRequirement, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationRequirement> {
        const localVarPath = this.basePath + '/TestSpecificationRequirement';
