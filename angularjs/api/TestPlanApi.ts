...
export class TestPlanApi {
     ...
     * @param body 
     */
    public create (body: models.TestPlan, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestPlan> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestPlan>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestPlan>> {
        const localVarPath = this.basePath + '/TestPlan/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestPlan> {
        const localVarPath = this.basePath + '/TestPlan/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestPlan>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestPlan>> {
        const localVarPath = this.basePath + '/TestPlans/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestPlan>> {
     ...
     * @param body 
     */
    public update (body: models.TestPlan, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestPlan> {
        const localVarPath = this.basePath + '/TestPlan';
