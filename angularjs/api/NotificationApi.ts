...
export class NotificationApi {
     ...
     * @param body 
     */
    public create (body: models.Notification, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Notification> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Notification>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Notification>> {
        const localVarPath = this.basePath + '/Notification/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Notification> {
        const localVarPath = this.basePath + '/Notification/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Notification>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Notification>> {
        const localVarPath = this.basePath + '/Notifications/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Notification>> {
     ...
     * @param body 
     */
    public update (body: models.Notification, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Notification> {
        const localVarPath = this.basePath + '/Notification';
