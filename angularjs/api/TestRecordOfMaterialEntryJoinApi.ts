...
export class TestRecordOfMaterialEntryJoinApi {
     ...
     * @param body 
     */
    public create (body: models.TestRecordOfMaterialEntryJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestRecordOfMaterialEntryJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestRecordOfMaterialEntryJoin>> {
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestRecordOfMaterialEntryJoin> {
        const localVarPath = this.basePath + '/TestRecordOfMaterialEntryJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestRecordOfMaterialEntryJoin>> {
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestRecordOfMaterialEntryJoin>> {
     ...
     * @param body 
     */
    public update (body: models.TestRecordOfMaterialEntryJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestRecordOfMaterialEntryJoin> {
        const localVarPath = this.basePath + '/TestRecordOfMaterialEntryJoin';
