...
export class OrganizationApi {
     ...
     * @param body 
     */
    public create (body: models.Organization, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Organization> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Organization>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Organization>> {
        const localVarPath = this.basePath + '/Organization/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Organization> {
        const localVarPath = this.basePath + '/Organization/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Organization>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Organization>> {
        const localVarPath = this.basePath + '/Organizations/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Organization>> {
     ...
     * @param body 
     */
    public update (body: models.Organization, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Organization> {
        const localVarPath = this.basePath + '/Organization';
