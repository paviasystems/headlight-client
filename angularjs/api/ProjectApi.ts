...
export class ProjectApi {
     ...
     * @param body 
     */
    public create (body: models.ProjectModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProjectModel> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProjectModel>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProjectModel>> {
        const localVarPath = this.basePath + '/Project/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProjectModel> {
        const localVarPath = this.basePath + '/Project/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProjectModel>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProjectModel>> {
        const localVarPath = this.basePath + '/Projects/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProjectModel>> {
     ...
     * @param body 
     */
    public update (body: models.ProjectModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProjectModel> {
        const localVarPath = this.basePath + '/Project';
