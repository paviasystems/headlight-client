...
export class TestSpecificationSetApi {
     ...
     * @param body 
     */
    public create (body: models.TestSpecificationSet, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationSet> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSet>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSet>> {
        const localVarPath = this.basePath + '/TestSpecificationSet/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationSet> {
        const localVarPath = this.basePath + '/TestSpecificationSet/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSet>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSet>> {
        const localVarPath = this.basePath + '/TestSpecificationSets/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestSpecificationSet>> {
     ...
     * @param body 
     */
    public update (body: models.TestSpecificationSet, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestSpecificationSet> {
        const localVarPath = this.basePath + '/TestSpecificationSet';
