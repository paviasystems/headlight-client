...
export class ProductionPlantApi {
     ...
     * @param body 
     */
    public create (body: models.ProductionPlant, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProductionPlant> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlant>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlant>> {
        const localVarPath = this.basePath + '/ProductionPlant/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProductionPlant> {
        const localVarPath = this.basePath + '/ProductionPlant/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlant>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlant>> {
        const localVarPath = this.basePath + '/ProductionPlants/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ProductionPlant>> {
     ...
     * @param body 
     */
    public update (body: models.ProductionPlant, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProductionPlant> {
        const localVarPath = this.basePath + '/ProductionPlant';
