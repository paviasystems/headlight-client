...
export class BidItemApi {
     ...
     * @param body 
     */
    public create (body: models.BidItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.BidItem> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BidItem>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BidItem>> {
        const localVarPath = this.basePath + '/BidItem/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.BidItem> {
        const localVarPath = this.basePath + '/BidItem/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BidItem>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BidItem>> {
        const localVarPath = this.basePath + '/BidItems/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BidItem>> {
     ...
     * @param body 
     */
    public update (body: models.BidItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.BidItem> {
        const localVarPath = this.basePath + '/BidItem';
