...
export class TestInstanceDataApi {
     ...
     * @param body 
     */
    public create (body: models.TestInstanceData, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceData> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceData>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceData>> {
        const localVarPath = this.basePath + '/TestInstanceData/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceData> {
        const localVarPath = this.basePath + '/TestInstanceData/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceData>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceData>> {
        const localVarPath = this.basePath + '/TestInstanceDatas/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceData>> {
     ...
     * @param body 
     */
    public update (body: models.TestInstanceData, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceData> {
        const localVarPath = this.basePath + '/TestInstanceData';
