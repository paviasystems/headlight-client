...
export class TestDataApi {
     ...
     * @param body 
     */
    public create (body: models.TestData, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestData> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestData>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestData>> {
        const localVarPath = this.basePath + '/TestData/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestData> {
        const localVarPath = this.basePath + '/TestData/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestData>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestData>> {
        const localVarPath = this.basePath + '/TestDatas/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestData>> {
     ...
     * @param body 
     */
    public update (body: models.TestData, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestData> {
        const localVarPath = this.basePath + '/TestData';
