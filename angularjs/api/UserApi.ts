...
export class UserApi {
    ...
    public getActiveUsers (extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/Users/Active';
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.UserModel>> {
        const localVarPath = this.basePath + '/User/query/readsLite';
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.UserModel>> {
        const localVarPath = this.basePath + '/Users/By/{field}/{value}/{begin}/{max}'
