...
export class DocumentPolyJoinApi {
    ...
    public _delete (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<boolean> {
        const localVarPath = this.basePath + '/DocumentPolyJoin/{id}'
    ...
    public count (extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InlineResponse200> {
        const localVarPath = this.basePath + '/DocumentPolyJoins/Count';
    ...
    public countFiltered (filter: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InlineResponse200> {
        const localVarPath = this.basePath + '/DocumentPolyJoins/FilteredTo/{filter}/Count'
     ...
     * @param body 
     */
    public create (body: models.DocumentPolyModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.DocumentPolyModel> {
        const localVarPath = this.basePath + '/DocumentPolyJoin';
    ...
    public postReadCountQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InlineResponse200> {
        const localVarPath = this.basePath + '/DocumentPolyJoin/query/count';
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.DocumentPolyModel>> {
        const localVarPath = this.basePath + '/DocumentPolyJoin/query/read';
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.DocumentPolyModel>> {
        const localVarPath = this.basePath + '/DocumentPolyJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.DocumentPolyModel> {
        const localVarPath = this.basePath + '/DocumentPolyJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.DocumentPolyModel>> {
        const localVarPath = this.basePath + '/DocumentPolyJoins/{begin}/{max}'
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.DocumentPolyModel>> {
        const localVarPath = this.basePath + '/DocumentPolyJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.DocumentPolyModel>> {
        const localVarPath = this.basePath + '/DocumentPolyJoins/FilteredTo/{filter}/{begin}/{max}'
            .replace('{' + 'filter' + '}', encodeURIComponent(String(filter)))
            .replace('{' + 'begin' + '}', encodeURIComponent(String(begin)))
            .replace('{' + 'max' + '}', encodeURIComponent(String(max)));
     ...
     * @param body 
     */
    public update (body: models.DocumentPolyModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.DocumentPolyModel> {
        const localVarPath = this.basePath + '/DocumentPolyJoin';
