...
export class OrganizationMaterialJoinApi {
     ...
     * @param body 
     */
    public create (body: models.OrganizationMaterialJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.OrganizationMaterialJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.OrganizationMaterialJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.OrganizationMaterialJoin>> {
        const localVarPath = this.basePath + '/OrganizationMaterialJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.OrganizationMaterialJoin> {
        const localVarPath = this.basePath + '/OrganizationMaterialJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.OrganizationMaterialJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.OrganizationMaterialJoin>> {
        const localVarPath = this.basePath + '/OrganizationMaterialJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.OrganizationMaterialJoin>> {
     ...
     * @param body 
     */
    public update (body: models.OrganizationMaterialJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.OrganizationMaterialJoin> {
        const localVarPath = this.basePath + '/OrganizationMaterialJoin';
