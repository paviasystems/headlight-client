...
export class ModuleApi {
     ...
     * @param body 
     */
    public create (body: models.ModuleModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ModuleModel> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ModuleModel>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ModuleModel>> {
        const localVarPath = this.basePath + '/Module/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ModuleModel> {
        const localVarPath = this.basePath + '/Module/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ModuleModel>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ModuleModel>> {
        const localVarPath = this.basePath + '/Modules/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ModuleModel>> {
     ...
     * @param body 
     */
    public update (body: models.ModuleModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ModuleModel> {
        const localVarPath = this.basePath + '/Module';
