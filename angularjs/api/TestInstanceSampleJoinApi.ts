...
export class TestInstanceSampleJoinApi {
     ...
     * @param body 
     */
    public create (body: models.TestInstanceSampleJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceSampleJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceSampleJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceSampleJoin>> {
        const localVarPath = this.basePath + '/TestInstanceSampleJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceSampleJoin> {
        const localVarPath = this.basePath + '/TestInstanceSampleJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceSampleJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceSampleJoin>> {
        const localVarPath = this.basePath + '/TestInstanceSampleJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstanceSampleJoin>> {
     ...
     * @param body 
     */
    public update (body: models.TestInstanceSampleJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstanceSampleJoin> {
        const localVarPath = this.basePath + '/TestInstanceSampleJoin';
