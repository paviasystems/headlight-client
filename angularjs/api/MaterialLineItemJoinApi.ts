...
export class MaterialLineItemJoinApi {
     ...
     * @param body 
     */
    public create (body: models.MaterialLineItemJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialLineItemJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialLineItemJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialLineItemJoin>> {
        const localVarPath = this.basePath + '/MaterialLineItemJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialLineItemJoin> {
        const localVarPath = this.basePath + '/MaterialLineItemJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialLineItemJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialLineItemJoin>> {
        const localVarPath = this.basePath + '/MaterialLineItemJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MaterialLineItemJoin>> {
     ...
     * @param body 
     */
    public update (body: models.MaterialLineItemJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MaterialLineItemJoin> {
        const localVarPath = this.basePath + '/MaterialLineItemJoin';
