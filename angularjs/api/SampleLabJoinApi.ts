...
export class SampleLabJoinApi {
     ...
     * @param body 
     */
    public create (body: models.SampleLabJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLabJoin> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLabJoin>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLabJoin>> {
        const localVarPath = this.basePath + '/SampleLabJoin/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLabJoin> {
        const localVarPath = this.basePath + '/SampleLabJoin/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLabJoin>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLabJoin>> {
        const localVarPath = this.basePath + '/SampleLabJoins/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLabJoin>> {
     ...
     * @param body 
     */
    public update (body: models.SampleLabJoin, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLabJoin> {
        const localVarPath = this.basePath + '/SampleLabJoin';
