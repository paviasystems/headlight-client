...
export class RecordOfMaterialApi {
     ...
     * @param body 
     */
    public create (body: models.RecordOfMaterial, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterial> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterial>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterial>> {
        const localVarPath = this.basePath + '/RecordOfMaterial/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterial> {
        const localVarPath = this.basePath + '/RecordOfMaterial/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterial>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterial>> {
        const localVarPath = this.basePath + '/RecordOfMaterials/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterial>> {
     ...
     * @param body 
     */
    public update (body: models.RecordOfMaterial, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterial> {
        const localVarPath = this.basePath + '/RecordOfMaterial';
