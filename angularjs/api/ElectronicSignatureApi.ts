...
export class ElectronicSignatureApi {
     ...
     * @param body 
     */
    public create (body: models.ElectronicSignatureModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ElectronicSignatureModel> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ElectronicSignatureModel>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ElectronicSignatureModel>> {
        const localVarPath = this.basePath + '/ElectronicSignature/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ElectronicSignatureModel> {
        const localVarPath = this.basePath + '/ElectronicSignature/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ElectronicSignatureModel>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ElectronicSignatureModel>> {
        const localVarPath = this.basePath + '/ElectronicSignatures/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.ElectronicSignatureModel>> {
     ...
     * @param body 
     */
    public update (body: models.ElectronicSignatureModel, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ElectronicSignatureModel> {
        const localVarPath = this.basePath + '/ElectronicSignature';
