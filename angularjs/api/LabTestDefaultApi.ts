...
export class LabTestDefaultApi {
     ...
     * @param body 
     */
    public create (body: models.LabTestDefault, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabTestDefault> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestDefault>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestDefault>> {
        const localVarPath = this.basePath + '/LabTestDefault/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabTestDefault> {
        const localVarPath = this.basePath + '/LabTestDefault/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestDefault>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestDefault>> {
        const localVarPath = this.basePath + '/LabTestDefaults/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestDefault>> {
     ...
     * @param body 
     */
    public update (body: models.LabTestDefault, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabTestDefault> {
        const localVarPath = this.basePath + '/LabTestDefault';
