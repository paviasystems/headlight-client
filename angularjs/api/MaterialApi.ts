...
export class MaterialApi {
     ...
     * @param body 
     */
    public create (body: models.Material, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Material> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Material>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Material>> {
        const localVarPath = this.basePath + '/Material/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Material> {
        const localVarPath = this.basePath + '/Material/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Material>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Material>> {
        const localVarPath = this.basePath + '/Materials/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Material>> {
     ...
     * @param body 
     */
    public update (body: models.Material, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Material> {
        const localVarPath = this.basePath + '/Material';
