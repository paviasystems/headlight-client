...
export class SampleLogApi {
     ...
     * @param body 
     */
    public create (body: models.SampleLog, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLog> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLog>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLog>> {
        const localVarPath = this.basePath + '/SampleLog/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLog> {
        const localVarPath = this.basePath + '/SampleLog/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLog>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLog>> {
        const localVarPath = this.basePath + '/SampleLogs/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.SampleLog>> {
     ...
     * @param body 
     */
    public update (body: models.SampleLog, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.SampleLog> {
        const localVarPath = this.basePath + '/SampleLog';
