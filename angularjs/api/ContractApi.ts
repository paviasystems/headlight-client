...
export class ContractApi {
     ...
     * @param body 
     */
    public create (body: models.Contract, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Contract> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Contract>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Contract>> {
        const localVarPath = this.basePath + '/Contract/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Contract> {
        const localVarPath = this.basePath + '/Contract/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Contract>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Contract>> {
        const localVarPath = this.basePath + '/Contracts/By/{field}/{value}/{begin}/{max}'
     ...
     * @param body 
     */
    public update (body: models.Contract, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Contract> {
        const localVarPath = this.basePath + '/Contract';
