...
export class LabMaterialAssignmentApi {
     ...
     * @param body 
     */
    public create (body: models.LabMaterialAssignment, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabMaterialAssignment> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabMaterialAssignment>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabMaterialAssignment>> {
        const localVarPath = this.basePath + '/LabMaterialAssignment/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabMaterialAssignment> {
        const localVarPath = this.basePath + '/LabMaterialAssignment/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabMaterialAssignment>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabMaterialAssignment>> {
        const localVarPath = this.basePath + '/LabMaterialAssignments/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabMaterialAssignment>> {
     ...
     * @param body 
     */
    public update (body: models.LabMaterialAssignment, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabMaterialAssignment> {
        const localVarPath = this.basePath + '/LabMaterialAssignment';
