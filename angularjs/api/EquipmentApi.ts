...
export class EquipmentApi {
     ...
     * @param body 
     */
    public create (body: models.Equipment, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Equipment> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Equipment>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Equipment>> {
        const localVarPath = this.basePath + '/Equipment/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Equipment> {
        const localVarPath = this.basePath + '/Equipment/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Equipment>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Equipment>> {
        const localVarPath = this.basePath + '/Equipments/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Equipment>> {
     ...
     * @param body 
     */
    public update (body: models.Equipment, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Equipment> {
        const localVarPath = this.basePath + '/Equipment';
