...
export class LabTestApprovalApi {
     ...
     * @param body 
     */
    public create (body: models.LabTestApproval, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabTestApproval> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestApproval>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestApproval>> {
        const localVarPath = this.basePath + '/LabTestApproval/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabTestApproval> {
        const localVarPath = this.basePath + '/LabTestApproval/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestApproval>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestApproval>> {
        const localVarPath = this.basePath + '/LabTestApprovals/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.LabTestApproval>> {
     ...
     * @param body 
     */
    public update (body: models.LabTestApproval, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LabTestApproval> {
        const localVarPath = this.basePath + '/LabTestApproval';
