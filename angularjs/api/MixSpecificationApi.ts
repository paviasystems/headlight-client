...
export class MixSpecificationApi {
     ...
     * @param body 
     */
    public create (body: models.MixSpecification, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MixSpecification> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecification>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecification>> {
        const localVarPath = this.basePath + '/MixSpecification/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MixSpecification> {
        const localVarPath = this.basePath + '/MixSpecification/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecification>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecification>> {
        const localVarPath = this.basePath + '/MixSpecifications/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.MixSpecification>> {
     ...
     * @param body 
     */
    public update (body: models.MixSpecification, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MixSpecification> {
        const localVarPath = this.basePath + '/MixSpecification';
