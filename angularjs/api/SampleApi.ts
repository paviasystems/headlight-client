...
export class SampleApi {
     ...
     * @param body 
     */
    public create (body: models.Sample, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Sample> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Sample>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Sample>> {
        const localVarPath = this.basePath + '/Sample/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Sample> {
        const localVarPath = this.basePath + '/Sample/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Sample>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Sample>> {
        const localVarPath = this.basePath + '/Samples/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.Sample>> {
     ...
     * @param body 
     */
    public update (body: models.Sample, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Sample> {
        const localVarPath = this.basePath + '/Sample';
