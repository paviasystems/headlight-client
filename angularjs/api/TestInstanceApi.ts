...
export class TestInstanceApi {
     ...
     * @param body 
     */
    public create (body: models.TestInstance, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstance> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstance>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstance>> {
        const localVarPath = this.basePath + '/TestInstance/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstance> {
        const localVarPath = this.basePath + '/TestInstance/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstance>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstance>> {
        const localVarPath = this.basePath + '/TestInstances/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.TestInstance>> {
     ...
     * @param body 
     */
    public update (body: models.TestInstance, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.TestInstance> {
        const localVarPath = this.basePath + '/TestInstance';
