...
export class RecordOfMaterialEntryApi {
     ...
     * @param body 
     */
    public create (body: models.RecordOfMaterialEntry, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterialEntry> {
     ...
     * @param body 
     */
    public postReadQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntry>> {
     ...
     * @param body 
     */
    public postReadsLiteQuery (body: models.QueryRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntry>> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntry/query/readsLite';
     ...
     * @param id ID of record
     */
    public read (id: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterialEntry> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntry/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public reads (begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntry>> {
     ...
     */
    public readsByValue (field: string, begin: number, max: number, value: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntry>> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntrys/By/{field}/{value}/{begin}/{max}'
     ...
     * @param max Maximum number of records to return
     */
    public readsFiltered (filter: string, begin: number, max: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.RecordOfMaterialEntry>> {
     ...
     * @param body 
     */
    public update (body: models.RecordOfMaterialEntry, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.RecordOfMaterialEntry> {
        const localVarPath = this.basePath + '/RecordOfMaterialEntry';
